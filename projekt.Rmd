...
Slika \ref{fig:slika10} prikazuje višino posameznega igralca. Ravna črta pa prikazuje povprečje.
...
Na sliki \ref{fig:slika11} sem pokazala koliko točk so dali igralci iz prvega in drugega polletja ter njihovo povprečje. Igralce iz prvega polletja sem označila z rdečo barvo, igralce iz drugega polletja pa z modro. 
...
Za boljšo analizo sem podatke razvrstila po doseženih točkah in izbrala 100 igralcev z največ doseženimi točkami. Ponovno sem jih razvrstila v dve polletji in izračunala skupne dosežene točke. Na grafu \ref{fig:slika12} vidimo, da so več točk dosegli igralci rojeni v drugem polletju.
...
Na grafu \ref{fig:slika12} vidimo, da so več točk dosegli igralci rojeni v drugem polletju.
